...
if __name__ == "__main__":
	...
	text2 = "Ashes fall from the sky...\n#@! Chaos reigns 9x!\n\nNothing will remain_2025"
	create_image_with_text(text1, "output1.png")
	create_image_with_text(text2, "output2.png")
    

	file1 = os.path.join(os.getcwd(), 'output1.png')
	file2 = os.path.join(os.getcwd(), 'output2.png')
    
	video_files = [f for f in os.listdir('videos') if os.path.isfile(os.path.join('videos', f)) and f.endswith('.mp4')]
	playlist_files = [file1, file2] + [os.path.join('videos', f) for f in video_files]
	...
	subprocess.run(['vlc', *parameters, *playlist_files])
